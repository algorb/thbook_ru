...
Подобно смотрите в |tex-fonts|, но дополнительно проверяет, установлены ли в системе шрифты \TeX \ . It does nothing if any of the specified fonts is not present. 
