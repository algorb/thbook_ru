...
When surveying caves in some large area, you often need to generate an up to date list of all caves in that area. В наборе данных, "пещера" может быть определена несколькими способами, в зависимости от уровня пещерной съемки. 
