...
* |\showpointerlist| с одним из аргументов |\pointerU| или |\pointerD| представ\-ляет содержание этого аргумента. Содержимое |\pointerU| и |\pointerD| смотрите выше. Для каждой записи он вызывает макрос |\processpointeritem|, который отвечает за форматирование данных. 
