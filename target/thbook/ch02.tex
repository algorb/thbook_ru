...
* |projection <specification>| = указывает проекцию чертежа. Each projection is identified by a type and optionally by an index in the form |type[:index]|. The index can be any keyword. The following projection types are supported: 
