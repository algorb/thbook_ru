...
* |scale <спецификация>| = используется для предварительного масштабирования (преобразования координат пикселей в метры) данных скрапа. Если проекция скрапа установлена в none, то это единственное преобразование, которое выполняется с координатами. |<specification>| имеет четыре формы: 
