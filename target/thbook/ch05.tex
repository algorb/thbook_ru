...
* |\showpointerlist| с одним из аргументов |\pointerU| или |\pointerD| представляет содержание этого аргумента. (Который содержит |\pointerU| или |\pointerD|, смотрите выше.) Для каждой записи он вызывает макрос |\processpointeritem|, который отвечает за форматирование данных. 
