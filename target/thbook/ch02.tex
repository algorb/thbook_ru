...
Порядок символов внутри каждой группы соответствует порядку команд во входном файле\[Или в меню {\font\it Команды в файле} XTherion'а]: символы, которые идут первыми, нарисованы последними (т.е. они отображаются в верхней части каждой группы). 
