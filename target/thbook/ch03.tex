...
* {\rightskip 0cm minus 4pt |symbol-assign <point/line/area/group/special> <symbol-type> <symbol-set>| = отображе\-ние определенного символа в заданном наборе символов. Этот опция переопределяет опцию |symbol-set|. 
