...
* в UNIX: |.|, |$THERION|, |$HOME/.therion|, |/etc|, |/usr/etc|, |/usr/local/etc|; * в Windows: |.|, |$THERION|, |$HOME\.therion|, |<Therion-installation-directory>|, |C:\WINDOWS|, |C:\WINNT|, |C:\Program Files\Therion| \endlist
