...
Даже если есть несколько возможностей, как сопоставить структуру\break префикса карты survex со структурой съемки Therion'а, самым чистым\break решением является создание структуры в .th файлах с использованием пустой пары |survey|/|endurvey| и всегда использовать |-surveys use| при импорте файлов .3d. 
