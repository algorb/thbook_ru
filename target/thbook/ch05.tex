...
* |\pointerU|, |\pointerD| содержат информацию о страницах выше и ниже текущей страницы. Они состоят из одной или нескольких конкатенированных записей. Каждая запись имеет специальный формат 
