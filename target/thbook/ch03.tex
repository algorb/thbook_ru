...
|<конфигурационный файл>| = Therion принимает только один необязатель\-ный аргумент: имя конфигурационного файла. Если имя не указано, то ищется файл |thconfig| в текущем каталоге. Если не существует файла |thconfig| (например, текущий каталог не является каталогом данных), Therion выдаст сообщение об ошибке. \endarguments
