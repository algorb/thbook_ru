...
По умолчанию разрез-развертка этой ситуации выглядит следующим образом: 
...
If we would like to start this branch from station 4, we need to forbid therion to extend station 5 from 1. Это можно сделать, указав 
