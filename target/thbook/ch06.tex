...
Если вы хотите добавить некоторые неподдерживаемые кодировки,\break прочитайте главу {\it Компиляция / Руководство хакера}; 
...
Февраль: Therion 0.5 -- Поддержка морфинга эскизов растровых изобра\-жений. \endlist
