...
За кодировкой должны следовать пять спецификаций шрифтов для обыч\-ных, курсивных, полужирных, без засечек и наклонных без засечек. Значе\-ние по умолчанию: |tex-fonts raw cmr10 cmti10 cmbx10 cmss10 cmssi10| 
