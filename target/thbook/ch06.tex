...
Легко добавить новые кодировки для вывода 2D-карты \[\NEW{5.3}Этот раздел относится к выбору шрифтов старого стиля с использованием команды |tex-fonts| в файле инициализации и устарела при использовании команды |pdf-fonts|.]. Скопируйте соот\-ветствующий файл сопоставления кодировки с расширением |*.enc| в\break |texenc/encodings|, запустить скрипт Perl |mktexenc.pl| расположенный в каталоге |texenc| и перекомпилируйте Therion. 
