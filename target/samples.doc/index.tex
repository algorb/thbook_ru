...
Как вы видите, даже если есть две станции с одинаковым именем, они отличаются друг от друга опцией |-from|, которая указывает\break предыдущую станцию в разрез-развертке. Используя этот скрап, вы получаете окончательную карту: 
