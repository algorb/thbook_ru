...
Макрос |\atlastitlepages| объединяет большинство перечисленных токенов, чтобы получить простой, предварительно отформатированный вывод страницы в виде атласа. 
