...
Это происходит потому, что в команде импорта верхнего уровня съемка\break {\it create} импортируется из файла |create/create.3d| с неправильными координатами, и мы импортируем файл .3d верхнего уровня с |-surveys use|. Это значит, что cave.create.1 будет импортироваться здесь как create.1@cave, а не 1@create.cave. 
