...
\NEW{5.3}Вне команды |layout| определяет систему координат для вывода. Невозможно указать несколько систем координат для разных выходных данных (последнее указание |cs| используется для всех выходных файлов). 
