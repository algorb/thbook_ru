...
3. |elevation| = ортогональная проекция (проецируемый профиль a.k.a.), кото\-рая опционально принимает в качестве аргумента азимут сечения (например, |[elevation 10]| или |[elevation 10 deg]|). 
