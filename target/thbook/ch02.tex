...
* |scale <спецификация>| = используется для предварительного масштабирования (преобразования координат пикселей в метры) данных скрапа. Если проек\-ция скрапа установлена в none, то это единственное преобразование, которое выполняется с координатами. |<Спецификация>| имеет четыре формы: 
