...
[:winter/summer]| (ток воздуха:зима/лето), |sink| (понор), |spring| (источник), |doline| (карстовая воронка), |dig| (раскоп), \NEW{5.3}|arch| (свод), |overhang| (нависание потолка). Также приставка |not| может быть использована перед флагом, чтобы удалить ранее добавленный флаг. 
