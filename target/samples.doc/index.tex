...
Чтобы отобразить карту {\it m2} в смещении, вам нужно создать карту, содержащую {\it m2}, и указать тип смещения и предварительного просмотра для {\it m2} на этой карте. Пример: 
