...
Ширина вышеуказанного текста может быть скорректирована с помощью регистра |\legendwidth| (его значение по умолчанию задано опцией\break |legend-width| эскиза). Цвет и размер текстов в преформатированной легенде можно легко изменить, используя |\legendtextcolor|, |\legendtextsize|, |\legendtextsectionsize| и |\legendtextheadersize| символьные регистры, например для большого синего текста: 
