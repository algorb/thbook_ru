...
Вы также можете экспортировать список всех продолжений из своего проекта, используя 

|export continuation-list -o questions.html | 

Файл questions.html содержит следующий список: 

\bigskip\begingroup\input etc/TXSruled.tex \LeftJustifyTables\ruledtable {\bf Комментарий}&{\bf Исследовано}&{\bf Съемка}&{\bf Станция}&{\bf Код}\cr слишком холодная вода для продолжения съемки&50.0&Пример пещеры&7&A\nr сильная тяга из разлома& &Пример пещеры&3&B\nr понор&20.0&Пример пещеры&5&V\endruledtable\endgroup\bigskip \subchapter {Использование пользовательских типов символов}. 
