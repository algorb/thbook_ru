...
* нажать кнопку {\it Масштаб} в меню {\it Скрап} и щелкнуть два разных места на изображении, где должны быть конечные точки калибровочной стрелки, или * переместить указатель мыши в нужную позицию, прочитать координаты указателя и ввести эти координаты в {\it масштабирующие точки для картинки} в меню {\it Скрап}.
