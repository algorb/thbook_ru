...
* устанавливается переменная {\it U} (пара) символа в $\left({width\over2},{height\over2}\right)$ для правильного выравнивания. Аргумент выравнивания {\it A} является парой значений,\break представляющих собой отношения $\left(shift_x\over U_x\right)$ и $\left(shift_y\over U_y\right)$. 
