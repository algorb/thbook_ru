...
Группа (group) может быть одной из следующих: all (все), centerline (нитка хода), sections (сечения), \NEW{5.3}water (вода), speleothems (спелеотемы), passage-fills (рельеф хода), \NEW{5.4} ice (лед), sediments (отложения), equipment (оборудование). 
