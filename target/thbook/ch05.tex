...
Новые символы могут быть определены в разделе |code metapost| команды\break |layout|. Это упрощает добавление новых символов во время выполнения. Также можно добавлять символы для постоянного использования, компилируя их в исполняемый файл Therion (смотрите. {\it Приложение} для инструкций, как это сделать). 
