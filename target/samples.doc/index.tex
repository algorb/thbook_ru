...
Если за этим входом есть какой-то разведанный проход, но вы не обследовали его должным образом, вы должны добавить также флаги |continuation| (продолжение) и |explored| (исследование), за которым следует исследуемая длина. Explored but unsurveyed passage lengths are also part of summary statistics. 
