...
\def\description{\par{\it ��������: } }
\def\enddescription{}

\def\arguments{\penalty-40\par{\it ���������:}\bgroup\nobreak\itemize}
\def\endarguments{\par\egroup}

\def\options{\penalty-40\par{\it �����:}\bgroup\nobreak\itemize}
\def\endoptions{\par\egroup}

\def\comopt{\penalty-40\par{\it ����� ��������� ������:}\bgroup\nobreak\itemize}
\def\endcomopt{\par\egroup}

\def\example{\penalty-40\par{\it ������:} }
\def\endexample{}
