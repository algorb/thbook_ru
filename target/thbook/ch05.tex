...
* установите переменную {\it U} (пара) символа в $\left({width\over2},{height\over2}\right)$ для правильного выравнивания. Аргумент выравнивания {\it A} представляет собой пару, представляющую отношения $\left(смещение_x\over U_x\right)$ и $\left(смещение_y\over U_y\right)$. 
