...
* {\rightskip 0cm minus 4pt |symbol-assign <point/line/area/group/special> <тип символа> <набор символов>| = отобра\-жение определенного символа в заданном наборе символов. Этот опция переопределяет опцию |symbol-set|.\par} 
