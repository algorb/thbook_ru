...
вставляет содержимое файла на место команды. Расширение по умолчанию - `.th' и его можно не указывать. Для максимальной портабельности используйте относительные пути, а для разделения каталогов используйте характерный для Unix `|/|', а не обратный слеш используемый в Windows `|\|',  \enddescription
