...
\else 
  ...
  \pdfinfo{/Title (The Therion Book \thversion)
           /Author (Martin Budaj, Stacho Mudr?k)
...
%modify by al_gorb
\font\rm=fhar6a at 12pt
\font\it=fhari6a at 12pt
\font\bf=fhab6a at 12pt
\font\tenrm=fhar6a at 10pt
\font\tt=fhar6a at 12pt
\font\eightit=fhari6a at 9pt
\font\my=cmr12 at 14pt
\font\delt=cmr12
%end modify
...
%modify by al_gorb
\font\chap=fhab6a at 16pt
\font\subchap=fhab6a at 13pt
%end modify
...
\def\syntax{\par{\it Синтаксис:} }
\def\endsyntax{}

\def\context{\par{\it Контекст:} }
\def\endcontext{}

\def\description{\par{\it Описание: } }
\def\enddescription{}

\def\arguments{\penalty-40\par{\it Аргументы:}\bgroup\nobreak\itemize}
\def\endarguments{\par\egroup}

\def\options{\penalty-40\par{\it Опции:}\bgroup\nobreak\itemize}
\def\endoptions{\par\egroup}

\def\comopt{\penalty-40\par{\it Опции командной строки:}\bgroup\nobreak\itemize}
\def\endcomopt{\par\egroup}

\def\example{\penalty-40\par{\it Пример:} }
\def\endexample{}

\def\notes{\par{\it Специальные пояснения:} }
\def\endnotes{}

\def\www{\@getoptionalarg\@www}
\def\@www#1{\ifx\pdfoutput\undefined
    \ifx\@optionalarg\empty{\tt#1}\else\@optionalarg\fi
  \else    \pdfstartlink attr {/Border [0 0 0]} user{%
        /Subtype /Link
        /A << 
            /Type /Action 
            /S /URI 
