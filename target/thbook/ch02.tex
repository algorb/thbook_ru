...
* {\it точечные символы:} символы наполнения ходов (почва\dots гуано) (bedrock\dots guano); * {\it линейные символы:} все символы линий, которые не имеют опцию |-outline|, за исключением |section| (|выносная линия сечения|), |arrow| (|стрелка|), |label| (|текстовая метка|), |gradient| (|уклон хода|) и |water-flow| (|водоток|) * {\it символы области:} все \endlist
