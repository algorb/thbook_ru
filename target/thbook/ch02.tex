...
{\it station (станция)}\[Если подтип станции не указан, Therion считает ее пикетом, если она указан в нитке хода.]{\it:} |temporary| (default), |painted|, |natural|, |fixed|; 
...
Подтип может быть указан также непосредственно в |<type>| с использованием `|:|' в качестве разделителя.\[Например, |station:fixed|.] 
