...
Март: Therion 0.1 -- Therion способен обрабатывать данные съемки (центральной линии) пещеры Мертвых летучих мышей. XTherion -- текстовый редактор, предназначенный для Therion'а (Tcl/Tk). 
