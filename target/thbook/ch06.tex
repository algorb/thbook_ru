...
Когда установлено значение |on| (по умолчанию), шрифты OpenType,\break используемые в |pdf-fonts|, преобразуются в шрифты PFB, если они осно\-ваны на PostScript. Некоторая информация теряется в формате PFB, но есть преимущество, что pdf \TeX\ может встраивать часть шрифтов PFB (в отличие от шрифтов OpenType, которые должны быть встроены полностью); 
