...
|<конфигурационный файл>| -- Therion принимает только один необязатель\-ный аргумент: имя конфигурационного файла. Если имя не указано, то используется имя |thconfig| в текущем каталоге. Если не существует |thconfig| файла (например, текущий каталог не является каталогом данных), Therion выдаст сообщение об ошибке. \endarguments
