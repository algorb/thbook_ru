...
При съемке пещер на какой-то большой территории вам часто нужно создать список всех пещер на этой территории. In therion dataset, "cave" can be defined in several ways, depending on the level of cave survey. 
