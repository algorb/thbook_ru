...
* установите переменную {\it U} (пара) в $\left({$ширина$\over2},{высота\over2}\right)$ символа для правильного выравнивания. Аргумент выравнивания {\it A} представляет собой пару, представляющую отношения $\left(смещение_x\over U_x\right)$ и $\left(смещение_y\over U_y\right)$. 
