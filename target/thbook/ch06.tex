...
Подобно смотрите в |tex-fonts|, но дополнительно проверяет, установлены ли в системе шрифты \TeX. Ничего не происходит, если какой-либо из указанных шрифтов отсутствует. 

Этот параметр используется по умолчанию для чешских/словацких и кириллических шрифтов, чтобы избежать ошибок \MP\ для систем без этих шрифтов. 

Поскольку тест занимает некоторое время (экземпляр pdfTeX запущен), вы можете полностью отключить поведение по умолчанию, установив |tex-fonts| в файле INI. 
