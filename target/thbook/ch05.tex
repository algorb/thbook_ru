...
* |\showpointerlist| с одним из аргументов |\pointerU| или |\pointerD| представ\-ляет содержание этого аргумента. Содержимое |\pointerU| и |\pointerD| смо\-трите выше. Для каждой записи он вызывает макрос |\processpointeritem|, который отвечает за форматирование данных. 
