...
* GNU C/C++ компилятор. * GNU make. * Perl. * Python 2.7 или 3. * Tcl/Tk 8.4.3 или новее (\www{https://www.tcl.tk}) с набором виджетов {\it BWidget} \hfil\break (\www{https://sourceforge.net/projects/tcllib/}) и необязательным расширением {\it tkImg} \hfil\break (\www{https://sourceforge.net/projects/tkimg/}). 
