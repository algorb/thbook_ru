...
Вы можете использовать |group cave-centerline|, |group surface-centerline|, |point cave-station|,\breack |point surface-station| и \NEW{5.4}|group text| в командах |symbol-hide| и |symbol-show|. 
