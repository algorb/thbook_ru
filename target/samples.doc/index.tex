...
Если Therion не содержит подходящий символ для ваших функции, вы\break можете нарисовать свой символ на карте, используя определенный тип\break символа (тип |u|, применяется для объектов точки, линии и области). 
...
Когда вы экспортируете карту без определения символов в \MP{},\break пользовательские символы выделяются красным цветом без какого-либо\break графического представления. 
...
в разделе вашего layout укажите символьную точку u:bat, подобный этому 
