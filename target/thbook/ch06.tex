...
в27 декабря: Therion впервые компилирует простую карту в формате PostScript (32 Кбайт Perl и 7 Кбайт \MP\ и \TeX\ исходного кода). Модель деформации карты существенно отличалась от текущей (позиции характеристик были относительно конкретного съемного замера, а не позиции всех станций в скрапе). Эта версия уже включала некоторые интересные функции, такие как {\it функции трансформации}, которые позволяли определять спецификацию входного формата для данных съемки или разбивать большие карты на несколько листов. 

30 декабря: первая веб-страница (с примерами данных, но без исходного кода). 
