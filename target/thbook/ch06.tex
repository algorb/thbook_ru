...
Работает только в Windows. Когда установлено значение |off| (по умол\-чанию), Therion временно очищает все переменные среды, связанные с \TeX. Useful if there is other \TeX distribution installed on your system which had set-up any environment variables, which could confuse \TeX\ and \MP\ programs supplied in Therion for Windows distribution. 
