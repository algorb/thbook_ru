...
* |\hsize|, |\vsize| = \TeX\ размеры страницы, заданные в соответствии с парамет\-рами |page-width| и |page-height| опции |page-setup| команды |layout|. Они устанавливают нашу площадку при определении макета страницы используя макрос |\dopage|. 
