...
Искажение скрапа вычисляется с использованием меры искажения, опреде\-ленной для всех пар точек (точечные символы, точки и контрольные точки линейных символов) в скрапе. Мера рассчитывается как $\left\vert d_a-d_b\right\vert\over d_b$, где $d_b$ -- это расстояние до деформирования, а $d_a$ -- расстояние до точек после деформиро\-вания. Максимальные и средние искажения скрапа вычисляются как максимальные или средние значения таких мер, применяемых ко всем парам точек. 
