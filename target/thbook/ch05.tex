...
* |\showpointerlist| с одним из аргументов |\pointerU| или |\pointerD| представ\-ляет содержание этого аргумента. (Который содержит |\pointerU| или |\pointerD|, смотрите выше.) Для каждой записи он вызывает макрос |\processpointeritem|, который отвечает за форматирование данных. 

Макрос |\showpointerlist| следует использовать без переопределения в том месте, где вы хотите отобразить содержимое своего аргумента; для форматирования пользовательских данных переопределите макрос |\processpointeritem|. 
...
* |\rm|, |\it|, |\bf|, |?|, |\si| для изменения типа отображения. \endlist
