...
Описание данных survey (нитки хода).  Синтаксис заимствован из Survex с небольшими изменениями; руководство Survex может быть полезно в ка\-честве дополнительной справки для пользователя. Можно использовать синоним `centerline'. \enddescription
