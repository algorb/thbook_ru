...
Все программы (за исключением пакетов BWidget и tkImg) обычно включа\-ются в дистрибутивы Linux, Unix или MacOS X. Для Windows необходимы MinGW и MSYS (\www {http://www.mingw.org}). Эти дистрибутивы содержат GNU make и GCC. (Кстати, почему бы не использовать предварительно скомпилированную версию для Windows?). 
