...
Съемки Therion'а почти соответствуют префиксам станций, определяемым парой |*begin|/|*end| в файлах. Обычно между ними не существует взаимно однозначного отображения. So if you want to keep your centerline in survex files you need to solve the problem how to match survex and therion data structures. This sample shows three different ways, how to deal with station prefixes when importing survex .3d files to therion. 
