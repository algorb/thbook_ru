...
Используя другие plain макросы \TeX\ или \TeX\ , можно добавить другие функции, например. другой макет для нечетных и четных страниц; заголовки и колонтитулы; или добавить логотип на каждую страницу. 
