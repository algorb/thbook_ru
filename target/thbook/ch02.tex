...
устанавливает кодировку входного файла. Это позволяет использовать символы не ASCII во входных файлах. \enddescription
...
* |<encoding-name>| = чтобы увидеть список всех поддерживаемых имен кодировок, запустите Therion с опцией |--print-encodings|. Кодировки `UTF-8' (Unicode) и `ASCII' (7 бит) всегда поддерживаются. \endarguments
