...
Если используется непосредственно файл PDF, то вам необходимо уста\-но\-вить DPI и формат вывода перед автоматическим преобразованием \[|Ghostscript| и |convert| должен быть установлен в вашей системе.
