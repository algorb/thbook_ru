...
Линейные символы отличаются от точечных символов тем, что нет\break локальной системы координат. Каждый линейный символ получает {\it путь} в абсолютных координатах в качестве первого аргумента. Поэтому необходимо установить переменную {\it T} в |identity| перед рисованием. 
