...
Используйте |flag:<entrance/continuation/sink/spring/doline/dig>| как |<тип символа>| скрыть станции с определенными флагами (например, |symbol-hide point flag:entrance|). 
