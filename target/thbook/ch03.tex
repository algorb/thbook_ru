...
выбирает объекты (съемки и карты) для экспорта. По умолчанию выбираются все объекты съемки. Если карта не выбрана, то выбираются все скрапы принадлежащие выбранным съемкам. 
