...
Используйте |flag:<entrance/continuation/sink/spring/doline/dig>| как |<symbol-type>|\endline чтобы скрыть станции с определенными флагами (например, |symbol-hide point flag:entrance|). 
