...
* {\rightskip 0cm minus 4pt |symbol-assign <point/line/area/group/special> <symbol-type> <symbol-set>| = display a particular symbol in the given symbol-set. Этот опция переопределяет опцию |symbol-set|. 
