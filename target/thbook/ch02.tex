...
Если карта в формате PDF была преобразована в растровое изображение с использованием внешней программы, конвертер использует растровое изображение {\it и} pdf-карту с тем же базовым именем, расположенным в том же каталоге, для вычисления калибровочных данных.
